...
\begin{algorithm}
\caption{Pravilo učenja perceptrona}
\label{algo:alg-perceptron}
\begin{algorithmic}
\STATE{\textbf{1:} Ciklički prolazi kroz svih \textit{N} uzoraka za učenje, jedan po jedan.}
\STATE{\textbf{2:} Klasificiraj trenutni uzorak.}
\bindent
\STATE{\textbf{1:} Ako se klasificira korektno, ne mijenjaj težine i}
\bindent\bindent
\STATE{\textbf{1:} ako je to \textit{N}-ti}
\STATE{\textbf{1:} Ako se klasificira korektno, ne mijenjaj težine i}
\eindent\eindent
\eindent
\REPEAT
