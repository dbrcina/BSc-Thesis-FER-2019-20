...
\label{mcp:eq}
    Y = 
    \begin{cases}
        1 & \text{if $\sum\limits_{i=1}^n I\textsubscript{i} = 0$ and $\sum\limits_{j=1}^m E\textsubscript{j} \geq T$} \\
        0 & \text{otherwise.}
    \end{cases}
\end{equation}
